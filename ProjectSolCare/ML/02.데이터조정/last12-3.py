...
file_paths = [
    "C:/workspace/ProjectData/hrs/selected_data/08.r4-r12_db/rand_filtered_r14_db.csv",
    "C:/workspace/ProjectData/hrs/selected_data/08.r4-r12_db/rand_filtered_r15_db.csv",
    "C:/workspace/ProjectData/hrs/selected_data/08.r4-r12_db/rand_filtered_r16_db.csv",
]
...
for file_path in file_paths:
    ...
    # 4. 
    rand['has_hibpe'] = rand['hibpe'].apply(lambda x: 1 if "1" in str(x) else (0 if "0" in str(x) else None))

    # 5. 기존 'demene2','alzhee2'  컬럼 삭제
    rand.drop(columns=['demene2', 'alzhee2', 'rabyear', 'radyear', 'hibpe'], inplace=True)
