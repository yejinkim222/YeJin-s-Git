...
for depth in [3, 5, 10]:
    ...
    results.append({"max_depth": depth, "r2_score": r2, "mse": mse})

# 결과 출력
results_df = pd.DataFrame(results)
print("RandomForest 회귀 성능 (R², MSE):")
print(results_df)

# 결과
# RandomForest 회귀 성능 (R², MSE):
#    max_depth  r2_score        mse
# 0          3  0.247026  21.038364
# 1          5  0.303277  19.466703
# 2         10  0.267164  20.475697
