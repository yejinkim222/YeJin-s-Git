...
print("\n🔍 XGBoost (ElasticNet 기반 피처 선택 후 재학습) 상위 3개 실험 결과")
for i, res in enumerate(top_results, 1):
    print(f"\n🔷 {i}. max_depth={res['max_depth']}, learning_rate={res['learning_rate']} → R² = {res['r2_score']:.4f}")
    importance = pd.Series(res['model'].feature_importances_, index=selected_features)
...
# 🔷 1. max_depth=3, learning_rate=0.01 → R² = 0.2441
#    📌 중요 변수:
#      - has_hibpe_missing: 0.3579
#      - AD_MCI_status: 0.0844
#      - risk_weighted_age: 0.0807
#      - years_until_db: 0.0788
#      - male_age: 0.0767

# 🔷 2. max_depth=3, learning_rate=0.03 → R² = 0.2422
#    📌 중요 변수:
#      - has_hibpe_missing: 0.3804
#      - AD_MCI_status: 0.0888
#      - risk_weighted_age: 0.0757
#      - years_until_db: 0.0751
#      - male_age: 0.0694

# 🔷 3. max_depth=3, learning_rate=0.1 → R² = 0.2375
#    📌 중요 변수:
#      - has_hibpe_missing: 0.4034
#      - AD_MCI_status: 0.0941
#      - years_until_db: 0.0718
#      - risk_weighted_age: 0.0692
#      - years_until_hibpe: 0.0641