...
features = [
    ...
    'years_until_db_missing', 'edu_yrs_missing',
    'age_group5', 'risk_factor_sum', 'edu_is_low',
    'risk_weighted_age', 'male_age', 'female_age'
]
...
for depth in range(1, 21):
    ...
    results['random_split'].append((depth, score_rand))
    ...
    results['time_split_14_16'].append((depth, score_14_16))

# 🔹 출력
print("\n📊 Random 80/20 Split")
for d, s in results['random_split']:
    print(f"  🔹 depth={d:2d} → R²: {s:.4f}")

print("\n📊 Time Split (2014+2016 as Test)")
for d, s in results['time_split_14_16']:
    print(f"  🔹 depth={d:2d} → R²: {s:.4f}")
