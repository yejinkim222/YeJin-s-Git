...
class InputDataForm(FlaskForm):
    ...
    gender = RadioField('Gender', choices=[('0','남성'),('1','여성')], coerce=int, validators=[DataRequired('성별은 필수 입력 항목입니다.')])
    edu_level = SelectField('Edu_level', choices=[('0','무학'),('1','초졸'),('2','중졸'),('3','고졸'),('4','대졸 dltkd')], coerce=int, validators=[DataRequired('교육 수준은 필수 입력 항목입니다.')])
